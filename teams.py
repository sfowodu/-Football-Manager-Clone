...
premteams = ['Arsenal', 'Aston Villa', 'Brighton', 'Brentford', 'Burnley', 'Chelsea', 'Crystal Palace', 'Everton', 'Leeds Utd', 'Leicester City', 'Liverpool', 'Manchester Utd', 'Manchester City', 'Newcastle Utd', 'Norwich City', 'Southampton', 'Spurs', 'Watford', 'West Ham Utd', 'Wolves']
