...
premteams = ['Arsenal', 'Aston Villa', 'Brighton', 'Burnley', 'Brentford', 'Chelsea', 'Crystal Palace', 'Everton', 'Leeds Utd', 'Leicester City', 'Liverpool', 'Manchester Utd', 'Manchester City', 'Newcastle Utd', 'Norwich City', 'Southampton', 'Spurs', 'Watford', 'West Ham Utd', 'Wolves']
...
from matchday import quickmatchsim, matchsim, Team
...
from graphics_table import createrichladder
from season_generator import make_season
    ...
    if userteamkey > 0:
        ...
        for g in data:
            ...
            if userteamkey == data[g]['key']:
                ...
                tactical_style = input("What tactical style do you want play? \n 1) Attacking \n 2) Defensive \n 3) Pressing \n 4) Vocal \n ")
                if tactical_style == "1":
                    data[g]['attack'] = rollattack + 30
                    data[g]['defense'] = rolldefense - 10
                    print("You boosted your attack but your defense went down!")

                elif tactical_style == "2":
                    data[g]['defense'] = rolldefense + 30
                    data[g]['attack'] = rollattack - 10
                    print("You boosted your defense but your attack went down!")

                elif tactical_style == "3":
                    data[g]['stamina'] = rollstamina + 30
                    data[g]['speed'] = rollspeed + 30
                    data[g]['defense'] = rollspeed - 10
                    print("You boosted your speed and stamina but your defense went down!")


                elif tactical_style == "4":
                    data[g]['luck'] = rollluck + 30
                    data[g]['stamina'] = rollstamina + 30
                    data[g]['speed'] = rollspeed - 10
                    print("You boosted your luck and stamina but your speed went down!")

                else:
                    print("No tactical style was selected...")
                ...
                for week in season:
                    ...
                    for matchbrackets in newweek:
                        ...
                        if userteam in match0:
                            ...
                            if gamechoice == "1":    
                                ...
                                print(' ')
                                matchsim(match1, data)
                                print(' ')
                                print('Gameweek: ' + str(gameweeknum))
                                print(' ')
                            
                            else:
                                quickmatchsim(match1, data)
                        else:
                            quickmatchsim(match1, data)
                    ...
                    if futurenum > 37:
                        ...
                        if upgradechoice == "1" or upgradechoice == "2" or upgradechoice == "3":
                            ...
                            print(' ')
                        #amount of upgrade will be randomly selected between 1-6
                        upgradeamount = random.randint(1,6)
                        #adds on upgrade
